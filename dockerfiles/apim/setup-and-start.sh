...
KEY_ALIAS="${WSO2_KEY_ALIAS:-wso2apim}"
...
if [ -z "${WSO2_SERVER_HOME:-}" ]; then
  log "WSO2_SERVER_HOME is not set; defaulting to /home/wso2carbon/wso2am-4.5.0"
  WSO2_SERVER_HOME="/home/wso2carbon/wso2am-4.5.0"
fi
